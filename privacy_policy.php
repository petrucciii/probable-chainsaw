...
<header class="header">
    <section class="header-head">
        <h2 class="text-danger header-content">L'Impero di Apollo</h2>
        <a href="index.php" class="header-content btn btn-danger">Home</a>
    </section>
    <section class="curved"></section>
</header>
<main>
<h1>Informativa sulla privacy</h1>
<p>Ultimo aggiornamento: 20 giugno 2021</p>
...
<p>Utilizziamo i tuoi dati personali per fornire e migliorare il Servizio. Utilizzando il Servizio, accetti la raccolta e l'utilizzo delle informazioni in conformità con la presente Informativa sulla privacy. Questa Informativa sulla privacy è stata creata con l'aiuto del <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Generatore di norme sulla privacy</a>.< /p>
<h1>Interpretazione e definizioni</h1>
<h2>Interpretazione</h2>
<p>Le parole la cui lettera iniziale è maiuscola hanno significati definiti alle seguenti condizioni. Le seguenti definizioni avranno lo stesso significato indipendentemente dal fatto che appaiano al singolare o al plurale.</p>
<h2>Definizioni</h2>
...
<li>
<p><strong>Società</strong> (indicata come &quot;la Società&quot;, &quot;Noi&quot;, &quot;Ci&quot; o &quot;Nostro&quot; in questo Accordo) si riferisce a L'Impero di Apollo.</ p>
</li>
<li>
...
<li>
<p><strong>Sito web</strong> si riferisce a L'Impero di Apollo, accessibile da <a href="https://apollospeed.altervista.org2" rel="external nofollow noopener" target="_blank">https ://apollospeed.altervista.org2</a></p>
</li>
<li>
<p><strong>Tu</strong> indica la persona che accede o utilizza il Servizio, o la società o altra persona giuridica per conto della quale tale persona accede o utilizza il Servizio, a seconda dei casi.</p>
</li>
</ul>
...
<p>I dati di utilizzo possono includere informazioni come l'indirizzo del protocollo Internet del tuo dispositivo (ad es. indirizzo IP), il tipo di browser, la versione del browser, le pagine del nostro servizio che visiti, l'ora e la data della tua visita, il tempo trascorso su quelle pagine , identificatori univoci del dispositivo e altri dati diagnostici.</p>
<p>Quando accedi al Servizio da o tramite un dispositivo mobile, potremmo raccogliere determinate informazioni automaticamente, incluso, ma non limitato a, il tipo di dispositivo mobile che utilizzi, l'ID univoco del tuo dispositivo mobile, l'indirizzo IP del tuo dispositivo mobile , il tuo sistema operativo mobile, il tipo di browser Internet mobile che utilizzi, identificatori univoci del dispositivo e altri dati diagnostici.</p>
...
<li><strong>Cookie Flash.</strong> Alcune funzionalità del nostro Servizio possono utilizzare oggetti memorizzati locali (o Cookie Flash) per raccogliere e memorizzare informazioni sulle tue preferenze o sulla tua attività sul nostro Servizio. I cookie Flash non sono gestiti dalle stesse impostazioni del browser utilizzate per i cookie del browser. Per ulteriori informazioni su come eliminare i cookie Flash, leggere &quot;Dove posso modificare le impostazioni per disabilitare o cancellare oggetti condivisi locali?&quot; disponibile su <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" rel="external nofollow noopener"> target="_blank" https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</a></li>
<li><strong>Web Beacon.</strong> Alcune sezioni del nostro Servizio e delle nostre e-mail possono contenere piccoli file elettronici noti come web beacon (noti anche come clear gif, pixel tag e single pixel gif) che consentono di Società, ad esempio, per contare gli utenti che hanno visitato quelle pagine o aperto un'email e per altre statistiche relative al sito web (ad esempio, registrazione della popolarità di una determinata sezione e verifica dell'integrità del sistema e del server).</li>
</ul>
<p>I cookie possono essere &quot;Persistenti&quot; o &quot;Sessione&quot; Biscotti. I cookie persistenti rimangono sul tuo personal computer o dispositivo mobile quando sei offline, mentre i cookie di sessione vengono eliminati non appena chiudi il tuo browser web. Ulteriori informazioni sui cookie: <a href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank">Cookie: cosa fanno?</a>.</p>
<p>Utilizziamo sia i cookie di sessione che i cookie persistenti per gli scopi indicati di seguito:</p>
<ul>
<li>
...
<li>
<p><strong>Politica sui cookie / Cookie di accettazione dell'avviso</strong></p>
...
<p>Tipo: Cookie persistenti</p>
<p>Amministrato da: Noi</p>
<p>Scopo: questi cookie ci consentono di ricordare le scelte che fai quando usi il sito web, come ricordare i tuoi dati di accesso o la lingua preferita. Lo scopo di questi cookie è di fornirti un'esperienza più personale ed evitare che tu debba reinserire le tue preferenze ogni volta che utilizzi il sito web.</p>
</li>
</ul>
...
<li>
<p><strong>Per l'esecuzione di un contratto:</strong> lo sviluppo, la conformità e l'assunzione del contratto di acquisto per i prodotti, gli articoli o i servizi che hai acquistato o di qualsiasi altro contratto con Noi tramite il Servizio.</ p>
</li>
<li>
<p><strong>Per contattarti:</strong> Per contattarti tramite e-mail, telefonate, SMS o altre forme equivalenti di comunicazione elettronica, come notifiche push di un'applicazione mobile relative ad aggiornamenti o comunicazioni informative relative alle funzionalità, prodotti o servizi appaltati, inclusi gli aggiornamenti di sicurezza, quando necessari o ragionevoli per la loro implementazione.</p>
</li>
<li>
<p><strong>Per fornirti</strong> notizie, offerte speciali e informazioni generali su altri beni, servizi ed eventi che offriamo simili a quelli che hai già acquistato o richiesto, a meno che tu non abbia scelto di non farlo ricevere tali informazioni.</p>
</li>
<li>
<p><strong>Per gestire le tue richieste:</strong> per partecipare e gestire le tue richieste nei nostri confronti.</p>
</li>
<li>
<p><strong>Per i trasferimenti di attività:</strong> potremmo utilizzare le tue informazioni per valutare o condurre una fusione, cessione, ristrutturazione, riorganizzazione, scioglimento o altra vendita o trasferimento di alcuni o tutti i nostri beni, sia come continuità aziendale o come parte di un fallimento, liquidazione o procedimento simile, in cui i Dati Personali da Noi detenuti sugli utenti del nostro Servizio sono tra i beni trasferiti.</p>
</li>
<li>
...
<li><strong>Per i trasferimenti di attività:</strong> possiamo condividere o trasferire le Sue informazioni personali in relazione o durante le negoziazioni di qualsiasi fusione, vendita di beni aziendali, finanziamento o acquisizione di tutto o parte dei Nostri affari a un'altra società.</li>
...
<p>Ti avviseremo tramite e-mail e/o un avviso ben visibile sul nostro servizio, prima che la modifica diventi effettiva e aggiorneremo il &quot;Ultimo aggiornamento&quot; data nella parte superiore della presente Informativa sulla privacy.</p>
...
<ul>
<li>Per email: imperodiapollo@gmail.com</li>
</ul>
</main>
